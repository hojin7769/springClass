...
<div id="content">
	...
	<p id="cur-page" class="margin-small">
		<span class="strong">1</span> / ${pageCount }page
	</p>
	<div id="pager-wrapper" class="margin-small">
		<div class="pager clear">
			<p id="btnPrev">
				<a class="button btn-prev" href="notice.htm">이전</a>
			</p>
			<ul>
				<li><a class="strong" href="">1</a></li>
				<li><a href="notice.htm?pg=2">2</a></li>
				<li><a href="notice.htm?pg=3">3</a></li>
				<li><a href="notice.htm?pg=4">4</a></li>
				<li><a href="notice.htm?pg=5">5</a></li>
			</ul>
			<p id="btnNext">
